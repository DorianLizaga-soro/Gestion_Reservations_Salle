...
document.body.addEventListener("click", (e) => {
  ...
  if (boutonSupprimer) {
    ...
    parent.location.href="PHP/codes/deleteReservation.php?id="+id;
    return;
  }
...
function changeButtonTitle() {
  ...
  document.getElementById("reservationForm").setAttribute("action","../Project_139_VS/PHP/codes/changeReservation.php");
}
...
document.getElementById("btnAdd").addEventListener("click",function(e) {
  ...
  document.getElementById("reservationForm").setAttribute("action","../Project_139_VS/PHP/codes/createReservation2.php");
  new bootstrap.Modal(document.getElementById("staticBackdrop")).show();
})