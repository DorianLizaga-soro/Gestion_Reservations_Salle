...
define('ID_CREATEUR_TEST', 1); // <-- adapte cet ID à un utilisateur réel de ta table `utilisateurs`
...
try {
    ...
    $ok = $stmt->execute([
        ...
        'id_creneau_recurrente' => $_POST['id_creneau_recurrente'] ?? null,
        'type'                   => $_POST['type'],
        'date_'                  => $_POST['date_'],
